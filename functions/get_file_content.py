...
schema_get_file_content = types.FunctionDeclaration(
    ...
    description="Reads and returns the content of a specified file relative to the working directory, with a character limit to prevent excessively long outputs",
